...
public class XmpReader implements MetadataReader
{
    ...
    public void extract(@NotNull final BufferReader reader, @NotNull Metadata metadata)
    {
        ...
        try {
            ...
            // This was changed from dc:title to dc:title[1] to extract object id information from the dc:title field
            processXmpTag(xmpMeta, directory, SCHEMA_DUBLIN_CORE_SPECIFIC_PROPERTIES, "dc:title[1]", XmpDirectory.TAG_TITLE, FMT_STRING);
